...
from db.models import (
    ...
    TenderDB, BidDB, CompanyDirectorDB,
)
...
async def seed_database():
        ...
        async with db.begin():
            ...
            for t in data["tenders"]:
                db.add(TenderDB(
                    ...
                    procurement_officer_id=make_uuid(t.procurement_officer_id) if t.procurement_officer_id else None,
                ))
            await db.flush()
    ...
    print(f"Seeded: {len(data['directors'])} directors, {len(data['companies'])} companies, "
